import { Bell, Bookmark, Home, Search, Users, User } from "lucide-react";
...
export default function Sidebar({ profile }: { profile?: Profile | null }) {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 grid grid-cols-6 border-t bg-white p-2 dark:bg-slate-900 lg:hidden">
